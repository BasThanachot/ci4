<div class="mb-4">
  <a href="<?= base_url('procurement_admin/manage') ?>"
...
<div class="bg-white rounded-xl shadow-sm overflow-hidden">
  <div class="px-6 py-4 border-b border-gray-100 flex items-center gap-3">
    ...
    <div>
      <h2 class="font-semibold text-gray-700"><?= htmlspecialchars($item->title) ?></h2>
      <p class="text-xs text-gray-400">ทั้งหมด <?= count($logs) ?> รายการ</p>
    </div>
  </div>
        ...
        <tbody class="divide-y divide-gray-100">
          <?php foreach ($logs as $log): ?>
            <tr class="hover:bg-gray-50 align-top">
              ...
              <td class="px-6 py-3 text-gray-500 max-w-xs whitespace-pre-wrap break-words">
                <?= htmlspecialchars($log->old_value ?? '-') ?>
              </td>
              <td class="px-6 py-3 text-gray-800 font-medium max-w-xs whitespace-pre-wrap break-words">
